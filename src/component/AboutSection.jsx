        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-4 justify-center">
            <a href="#contact" className="cosmic-button">
             ...
             <a href="https://drive.google.com/drive/folders/1v9wHlqUGjXZapAsVgBdWE6Z-wmI6J80y?usp=sharing" className="px-6 py-2 rounded-full border border primary text-primary hover:bg-primary/10 transition-colors duration-300">
              Download CV
            </a>
          </div>
        </div>
